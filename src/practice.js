...
class practice extends Component {
  ...
  componentDidMount() {
    ...
    axios.get('https://classcast-198812.appspot.com/white_label/get_test_series_list/52')
        .then((response) => 
        {
           console.log("sdnjsnjnaskj : "+JSON.stringify(response.data));
           this.setState({ test_series_list: response.data.filter(function (test) { return test.free_test_available })  });
        })
        .catch((error) => {
